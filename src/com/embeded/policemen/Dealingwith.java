...
public class Dealingwith extends Activity implements OnGetRoutePlanResultListener {
	...
	private String weizhi, weidu, jingdu, id,userid, peoplephone, peoplename, infor,
			time123, length, policename, policephone, responseMsg = "",
	...
	TextView weiz, call, Preparemessage, more, back;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.prepare_pager);
	...
	void InitMap() {
		...
		Preparemessage = (TextView) findViewById(R.id.preparemessage);
	...
	void Initclick() {
		...
		OnClickListener btnClickListener = new OnClickListener() {
			public void onClick(View v) {
				...
				} else if (v.equals(Preparemessage)) {
					Intent intent = new Intent(Dealingwith.this, PrepareMore.class);
					
					intent.putExtra("id", id);
					intent.putExtra("userid", userid);
					intent.putExtra("infor", infor);
					intent.putExtra("time", time123);
					intent.putExtra("peoplenum", peoplephone);
		...
		Preparemessage.setOnClickListener(btnClickListener);
	...
	public void Initmarketclick() {
		OnMarkerClickListener onClickListener = new OnMarkerClickListener() {
			public boolean onMarkerClick(final Marker marker) {
				button = new Button(Dealingwith.this.getApplicationContext());
	...
	private boolean policeupdate() {
		...
		// use HTTP
		String urlStr = "http://219.245.64.1:8080/service/servlet/PUpdateServlet";
	...
	Runnable runnable = new Runnable() {
		...
		public void run() {
			...
			up();
			abc = "0";
			Toast.makeText(Dealingwith.this, "刷新线程", Toast.LENGTH_SHORT).show();
	...
	public void onStart() {
		...
		mBaiduMap = mMapView.getMap();
		mBaiduMap.setMyLocationEnabled(true);
		mLocClient = new LocationClient(Dealingwith.this);
		mLocClient.registerLocationListener(myListener);
		LocationClientOption option = new LocationClientOption();
		// 设置定位模式
		option.setAddrType("all");
	...
	public void onGetDrivingRouteResult(DrivingRouteResult result) {
		if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
			Toast.makeText(Dealingwith.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
		}
