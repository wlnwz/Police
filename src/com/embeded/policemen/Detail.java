...
public class Detail extends Activity implements OnGetRoutePlanResultListener {
	...
	private double weidu1, jingdu1, weidulast = 0, jingdulast = 0;
...
//						mBaiduMap.animateMapStatus(u);
	...
	// // show popup
	// popupText = new TextView(Detail.this);
	...
	Runnable runnable = new Runnable() {
		...
		@Override
		public void run() {
			if ((weidulast < (weidu1 + 0.00003))
					&& (weidulast > (weidu1 - 0.00003))
					&& (jingdulast < (jingdu1 + 0.00003))
					&& (jingdulast > (jingdu1 - 0.00003))) {
