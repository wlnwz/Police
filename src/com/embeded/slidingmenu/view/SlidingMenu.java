			...
			if (mScroller.computeScrollOffset()) {
				...
				if (oldX != x || oldY != y) {
					if (mSlidingView != null) {
						...
						if (x < 0)
							bgShade.scrollTo(x + 20, y);// 闁煎啿鏈�?��娆撴⒓閺夋垵顨查柛娆忓暱娴滐�?					
						else
							bgShade.scrollTo(x - 20, y);// 闁煎啿鏈�?��娆撴⒓閺夋垵顨茬�闈╃畱娴滐�?				
						}
				}
				invalidate();
			}
